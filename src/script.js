...
const normalTexture = textureLoader.load('https://oloys313.github.io/static//textures/CircleGriNormal.png')
...
pointLight2.position.set(-1.53,2.04,-1.21)
pointLight2.intensity = 2.95
scene.add(pointLight2)

//Light 3
const pointLight3 = new THREE.PointLight(0xff00ff, 2)
pointLight3.position.set(1.2,-1.6,0.74)
pointLight3.intensity = 1.71
